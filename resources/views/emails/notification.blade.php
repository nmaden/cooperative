...
<body>
    <div class="newsletter__emailmessage emailmessage">
        ...
        <div class="emailmessage__body emailmessage__border"    style=" padding: 20px; border-left: 10px solid; border-right: 10px solid; border-color: {{$emailProperties->color}};">
            ...
            <div class="newsletter__column" style="position: relative; padding-top: 10px;">
                ...
                <p class="emailmessage__text" style="font-weight: normal;">{{$emailProperties->text}}</p>
            ...
            @if ($emailProperties->status_booking === 1)
                <div class="newsletter__column" style="position: relative; padding-top: 10px;">
                    ...
                    <table width="100%"  align="center" 
                        ...
                        <tr> 
                            <td style="border-left: 1px solid #ccc; border-bottom: 1px solid #ccc"><p class="emailmessage__text">Ночей {{$differenceNight}}</p></td>
                        </tr>
                    </table>
        ...
        <div class="emailmessage__footer" style="text-align: center; padding: 20px; margin-top: -20px; color: white; border-left: 10px solid; border-bottom: 10px solid; border-right: 10px solid;background: #FFCE03; border-color: {{$emailProperties->color}};">
            <p class="emailmessage__text" style="font-weight: normal;">© 2020 Отель {{$transaction->hotel->name}} Казахстан, {{$transaction->hotel->region_id}} область, {{$transaction->hotel->area_id}} район, г. {{$transaction->hotel->locality_id}}, ул. {{$transaction->hotel->street}},, д. {{$transaction->hotel->house}}</p>
