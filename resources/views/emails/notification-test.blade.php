...
<body>
    <div class="newsletter__emailmessage emailmessage">
        ...
        <div class="emailmessage__body emailmessage__border"    style="display: block; padding: 20px; border-left: 10px solid; border-right: 10px solid; border-color: {{$emailProperties->color}};">
            <div class="emailmessage__head" style="display: flex; flex-direction: row; align-items: center; margin-bottom: 10px; position: relative">
                ...
                <div class="emailmessage__contact">
                    <p class="emailmessage__name">#nameHotel</p>
                </div>
            </div>
            ...
            @if ($emailProperties->status_booking === 1)
                <div class="newsletter__column" style="position: relative; padding-top: 10px;">
                    ...
                    <table width="100%"  align="center" 
                        ...
                        <tr > 
                        <td style="border-top:1px solid #ccc; border-bottom: 1px solid #ccc; border-left: 1px solid #ccc "><p class="emailmessage__text">Заезд: #arrival</p></td>
                        <td style="border: 1px solid #ccc" rowspan="2"><p class="emailmessage__text">Выезд: #checkOut</p></td>
                        </tr>
                        <tr> 
        ...
        <div class="newsletter__column" style="display: block; position: relative; padding-top: 10px;">   
        ...
        <div class="emailmessage__footer" style="display: block; text-align: center; padding: 20px; margin-top: -20px; color: white; border-left: 10px solid; border-bottom: 10px solid; border-right: 10px solid;background: #FFCE03; border-color: {{$emailProperties->color}};">
            <p class="emailmessage__text" style="font-weight: normal;">© 2020 Отель #nameHotel Казахстан, #region область, #area район, г. #locality, ул. street, д. #house</p>
